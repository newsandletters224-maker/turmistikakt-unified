    ...
    sections: [{
      ...
      children: [
        ...
        new Paragraph({
          ...
          children: [
            new TextRun({
              text: '6. Отбасылық жағдайы: ',
              size: 24,
              font: 'Times New Roman',
            }),
            new TextRun({
              text: data.maritalStatus || '________________________',
              size: 24,
              font: 'Times New Roman',
            }),
          ],
        ...
        new Paragraph({
          ...
          children: [
            new TextRun({
              text: '7.1. Тұрғын үй-тұрмыстық жағдайы:',
              bold: true,
              size: 24,
              font: 'Times New Roman',
            }),
        ...
        new Paragraph({
          ...
          children: [
            new TextRun({
              text: '7.2. Денсаулық жағдайы мен өзіне-өзі қызмет көрсету қабілеті:',
              bold: true,
              size: 24,
              font: 'Times New Roman',
            }),
        ...
        new Paragraph({
          ...
          children: [
            new TextRun({
              text: '7.3. Қажетті әлеуметтік қызмет түрлері:',
              bold: true,
              size: 24,
              font: 'Times New Roman',
            }),
