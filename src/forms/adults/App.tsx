    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 py-6 sm:px-6 sm:py-8">
        ...
        <form onSubmit={(e) => { e.preventDefault(); handleDownload(); }} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-3 py-2 pr-16 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-base"
                      placeholder="0"
                    />
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Отбасылық жағдайы
                    <span className="text-xs text-gray-500 ml-1">(жалғыз басты / отбасымен), балалары немесе бауырлары, туысқандары туралы мәліметтер</span>
                  </label>
                  <textarea
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-base"
                    rows={3}
                    placeholder="Жалғыз басты. Балалары: ... Бауырлары/туысқандары: ..."
                  />
                </div>
              </div>
            </div>
          ...
          {/* Section 7: Housing */}
          <FormSection title="7. Тұрғын үй-тұрмыстық жағдайы" subtitle="Жилищно-бытовые условия">
            <div className="space-y-4">
              {/* Housing type */}
              <div>
              ...
              {/* Yard plot */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Аулалық учаскенің болуы</label>
                <div className="flex flex-col sm:flex-row gap-3">
                  <label className={`flex items-center gap-2 px-4 py-3 border rounded-lg cursor-pointer transition-colors ${formData.hasYardPlot === 'bar' ? 'border-blue-500 bg-blue-50' : 'border-gray-300 hover:bg-gray-50'}`}>
                    <input
                      type="radio"
                      name="hasYardPlot"
                      checked={formData.hasYardPlot === 'bar'}
                      onChange={() => updateField('hasYardPlot', 'bar')}
                      className="w-4 h-4 text-blue-600"
                    />
                    <span className="text-sm">Бар</span>
                  </label>
                  <label className={`flex items-center gap-2 px-4 py-3 border rounded-lg cursor-pointer transition-colors ${formData.hasYardPlot === 'joq' ? 'border-blue-500 bg-blue-50' : 'border-gray-300 hover:bg-gray-50'}`}>
                    <input
                      type="radio"
                      name="hasYardPlot"
                      checked={formData.hasYardPlot === 'joq'}
                      onChange={() => updateField('hasYardPlot', 'joq')}
                      className="w-4 h-4 text-blue-600"
                    />
                    <span className="text-sm">Жоқ</span>
                  </label>
                </div>
                {formData.hasYardPlot === 'bar' && (
                  <div className="mt-3 pl-4 border-l-2 border-blue-200 max-w-xs">
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                      Учаскенің көлемі
                      <span className="text-xs text-gray-500 ml-1">(га)</span>
                    </label>
                    <input
                      type="text"
                      value={formData.yardPlotHectares}
                      onChange={(e) => updateField('yardPlotHectares', e.target.value)}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-base"
          ...
          {/* Section 8: Health */}
          <FormSection title="8. Денсаулық жағдайы мен өзіне-өзі қызмет көрсету қабілеті" subtitle="Состояние здоровья и самообслуживание">
            <div className="space-y-4">
              <div>
          ...
          {/* Section 9: Services */}
          <FormSection title="9. Қажетті әлеуметтік қызмет түрлері" subtitle="Необходимые виды социальных услуг">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-base"
                  placeholder="Актіні түзушінің аты-жөні"
                />
              </div>
            </div>
