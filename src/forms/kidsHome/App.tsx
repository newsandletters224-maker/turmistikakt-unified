        ...
        <div className="space-y-8">
          ...
          <section className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-5">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  14. Аулалық учаскенің болуы
                </label>
                <RadioGroup
                  name="hasYardPlot"
                  value={form.hasYardPlot}
                  onChange={(val) => update('hasYardPlot', val)}
                  options={[
                    { value: 'бар', label: 'Бар' },
                    { value: 'жоқ', label: 'Жоқ' },
                  ]}
                />
                {form.hasYardPlot === 'бар' && (
                  <div className="mt-3 pl-4 border-l-2 border-blue-100 max-w-xs">
                    <label className="block text-xs text-gray-500 mb-1">Учаскенің көлемі (га)</label>
                    <input
                      type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  15. Балаға жасалған арнайы жағдайлар мен бейімделу
                </label>
          ...
          <section className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-5">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  16. Негізгі диагнозы (медициналық картаға сәйкес)
                </label>
                <textarea
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  17. Қозғалу және өзіне-өзі қызмет көрсету қабілеті
                </label>
                <div className="space-y-3 pl-4 border-l-2 border-blue-100">
                  <div>
          ...
          <section className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-3">
              {[
                ...
                { key: 'socialCultural' as const, title: 'Әлеуметтік-мәдени қызметтер', desc: 'мерекелер мен демалыс іс-шараларын ұйымдастыру, клуб және үйірме жұмыстарына, мәдени іс-шараларға қатыстыру.' },
                { key: 'socialLabor' as const, title: 'Әлеуметтік-еңбек қызметтері', desc: 'тірек-қимыл аппараты бұзылған балаларға кәсіптік бағдар беру, тұрмыстық және қол шеберлігінің негіздеріне үйрету.' },
              ].map((service) => (
