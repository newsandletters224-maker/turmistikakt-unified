      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 space-y-8">
          ...
          <Section title="III. ТҰРҒЫН ҮЙ ЖӘНЕ ҚАТЫНАУ (КӨЛІК) ЖАҒДАЙЛАРЫ" subtitle="Жильё и транспортная доступность">
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">
                12. Күндізгі болу орталығына қатынау мүмкіндігі <span className="text-xs text-gray-500">(Возможность посещения центра)</span>
              </label>
          ...
          <Section title="IV. БАЛАНЫҢ ДЕНСАУЛЫҚ ЖАҒДАЙЫ ЖӘНЕ ЖАРТЫЛАЙ СТАЦИОНАРҒА КЕЛУ МҮМКІНДІГІ" subtitle="Здоровье и возможность посещения центра">
            <Field label="13. Негізгі диагнозы (медициналық құжаттарға сәйкес)" hint="Основной диагноз (по мед. документам)">
              <textarea
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">
                14. Қозғалу және ортада бейімделу қабілеті <span className="text-xs text-gray-500">(Способность к передвижению и адаптации)</span>
              </label>
              <div className="space-y-3 pl-4 border-l-2 border-indigo-200">
                <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Field label="15. ПМПК қорытындысы — №" hint="Психолого-медико-педагогическая консультация — номер">
                <input
                  type="text"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Field label="16. АОЖБ №" hint="ИПРА — Индивидуальная программа реабилитации и абилитации">
                <input
                  type="text"
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">
                17. Ұжымдық/топтық ортада болуға кері көрсетілімдері <span className="text-xs text-gray-500">(Противопоказания для пребывания в коллективе)</span>
              </label>
              <div className="space-y-2">
                <label className="flex items-center gap-2 text-sm">
